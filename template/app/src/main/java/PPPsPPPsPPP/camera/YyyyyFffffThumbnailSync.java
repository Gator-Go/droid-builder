 ...
 * Lllll
 *
 * This is a YyyyyFffffThumbnailSync helper that uploads/syncs
 * a thumbnail file to the server.
 * It is a background task that syncs a thumbnail image to the
 * remote server.
 *
 * @author Aaaaa
...
public class YyyyyFffffThumbnailSync {
  private static String TAG = "YyyyyFffffThumbnailSync";
  private final Context context;

  public YyyyyFffffThumbnailSync(Context context) {
    this.context = context;
  }



  public void syncThumbnail(String cloudId, String fffffVersion) {
  ...
  private static class FileSyncTask extends AsyncTask<Void, Void, Void> {
    ...
    protected Void doInBackground(Void... params) {
        ...
        String thumbnailPath = "/Yyyyy/Fffff/" + cloudId + "-" + fffffVersion + ".jpg";
        String thumbnailUrl = urlDown + "op=YyyyyFffffUploadSyncAAAAAcloudId=" + cloudId + "AAAAAfffffVersion=" + fffffVersion;
