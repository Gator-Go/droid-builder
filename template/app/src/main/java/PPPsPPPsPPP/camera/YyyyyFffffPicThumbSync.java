...
public class YyyyyFffffPicThumbSync {
  private static String TAG = "YyyyyFffffPicThumbSync";
  private final Context context;

  public YyyyyFffffPicThumbSync(Context context) {
    this.context = context;
  }



  public void syncPicThumb(String cloudId, String fffffVersion) {
  ...
  private static class FileSyncTask extends AsyncTask<Void, Void, Void> {
    ...
    protected Void doInBackground(Void... params) {
        ...
        String thumbnailPath = "/Yyyyy/Fffff/" + cloudId + "PicThumb" + fffffVersion + ".jpg";
        String thumbnailUrl = urlDown + "YyyyyFffffThumbSyncAAAAAcloudId=" + cloudId + "AAAAAfffffVersion=" + fffffVersion + "&postingType=pic";
