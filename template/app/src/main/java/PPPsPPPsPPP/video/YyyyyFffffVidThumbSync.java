 ...
 * Lllll
 *
 * This is a YyyyyFffffVidThumbSync helper that uploads/syncs a video
 * thumbnail to the server.
 * It is a background task that syncs a video thumbnail to the remote server.
 *
 * @author Aaaaa
...
public class YyyyyFffffVidThumbSync {
  private static String TAG = "YyyyyFffffVidThumbSync";
  private final Context context;

  public YyyyyFffffVidThumbSync(Context context) {
    this.context = context;
  }



  public void syncVidThumb(String cloudId, String fffffVersion) {
  ...
  private static class FileSyncTask extends AsyncTask<Void, Void, Void> {
    ...
    protected Void doInBackground(Void... params) {
        ...
        String thumbnailPath = "/Yyyyy/Fffff/" + cloudId + "VidThumb" + fffffVersion + ".jpg";
        String thumbnailUrl = urlDown + "YyyyyFffffThumbSyncAAAAAcloudId=" + cloudId + "AAAAAfffffVersion=" + fffffVersion + "&postingType=vid";
        xxxxxSyncDownFile.syncDownFile(context, thumbnailPath, thumbnailUrl, AUTHORIZATION);

        Log.d("*** FileSyncTask ***", "thumbnailPath: " + thumbnailPath + "   thumbnailUrl: " + thumbnailUrl);
