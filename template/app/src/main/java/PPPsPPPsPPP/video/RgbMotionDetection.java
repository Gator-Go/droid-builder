...
Log.e(TAG, "%%%%%%%%%%%%%%%%%%%%%%% totDifferentPixels: " + totDifferentPixels);
...
Log.e(TAG, "%%%%%%%%%%%%%%%%%%%%%%% Creating background image: ");
            return false;
        }
