...
public class MultipartUtility {
    ...
    private static MultipartUtility mInstance = null;

    private MultipartUtility() {
    }

    public static MultipartUtility getInstance() {
      if (mInstance == null) {
          mInstance = new MultipartUtility();
      }
      return mInstance;
    }


    public static void sslConnection(Context myContext, String url, String authorization) {
      try {
        ...
        Log.e(TAG, "Failed to establish connection: " + ex.toString(), ex);
        // Optionally re-throw or handle cleanup here
      }
    }
