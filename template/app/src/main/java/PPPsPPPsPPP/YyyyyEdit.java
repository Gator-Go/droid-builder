...
___EDIT_FLAG_POST___
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.yfyfy_edit);
    res = getResources();
...
___DAO_NEW_TAG___
    ...
    id.setText("ID: " + yyyyy.getCloudId());
    cameraHelper = new CameraHelper(this);

___EDIT_SET_INTEGER___
___EDIT_SET_STRING___
___EDIT_SET_CLOB___
___EDIT_SET_ENUM___
___EDIT_SET_TAG___
___EDIT_SET_DOUBLE___
___EDIT_SET_MONEY___
___EDIT_SET_DATE___
___EDIT_SET_DATE_TIME___
___EDIT_SET_BOOLEAN___
___EDIT_SET_CAMERA___
___EDIT_SET_VIDEO___
___EDIT_SET_THUMBNAIL___
___EDIT_SET_POST___
___EDIT_SET_LOC___
___EDIT_SET_CURRENT_LOC___
___EDIT_SET_ONE2MANY_CHILD___
...
___EDIT_LOAD_INTEGER___
___EDIT_LOAD_STRING___
___EDIT_LOAD_CLOB___
___EDIT_LOAD_ENUM___
___EDIT_LOAD_TAG___
___EDIT_LOAD_DOUBLE___
___EDIT_LOAD_MONEY___
...
___EDIT_PHOTO_VERSION_CAMERA___
___EDIT_PHOTO_VERSION_VIDEO___
___EDIT_PHOTO_VERSION_THUMBNAIL___
___EDIT_PHOTO_VERSION_POST___

      yyyyyDao.editYyyyy(yyyyy);

___EDIT_PHOTO_SAVE_CAMERA___
___EDIT_PHOTO_SAVE_VIDEO___
___EDIT_PHOTO_SAVE_THUMBNAIL___
___EDIT_PHOTO_SAVE_POST___
...
___POST_READY___
            ...
            Log.d(TAG, "onResume postingFile not found");
            whichStr = "";
___PHOTO_NOT_READY___
___THUMBNAIL_NOT_READY___
___POST_NOT_READY___
