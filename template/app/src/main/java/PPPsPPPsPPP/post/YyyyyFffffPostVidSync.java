 ...
 * Lllll
 *
 * This is a YyyyyFffffPostVidSync helper that uploads/syncs a
 * post video to the server.
 * It is a background task that syncs a post video to the remote server.
 *
 * @author Aaaaa
...
public class YyyyyFffffPostVidSync {
 private static String TAG = "YyyyyFffffPostVidSync";
  private final Context context;

  public YyyyyFffffPostVidSync(Context context) {
  ...
  private static class FileSyncTask extends AsyncTask<Void, Void, Void> {
    ...
    protected Void doInBackground(Void... params) {
        ...
        String videoUrl = urlDown + "FffffUploadSyncAAAAAcloudId=" + cloudId + "AAAAAfffffVersion=" + fffffVersion + "AAAAApostingType=vid";
